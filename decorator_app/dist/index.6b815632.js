...
(0, _tsDecorate._)([
    (0, _validatorDefault.default).register([
        "required"
    ])
...
personForm?.addEventListener("submit", (e)=>{
    ...
    if (!(0, _validatorDefault.default).validate(newPerson)) console.log("No pas\xf3 la validaci\xf3n");
});

},{"@swc/helpers/_/_ts_decorate":"lX6TJ","./Decorators/validator":"iZylf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lX6TJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"iZylf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function validator() {
    const validations = {};
    return {
        register (types) {
            return (target, propName)=>{
                ...
                if (!validations[constructorName]) validations[constructorName] = {
                    [propName]: types
                };
                else validations[constructorName][propName] = types;
            };
        },
        validate (obj) {
            const validationRegistered = validations[obj.constructor.name];
            if (!validationRegistered) return true;
            let passed = true;
            for(const prop in validationRegistered)validationRegistered[prop].forEach((validation)=>{
                switch(validation){
                    case "required":
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1G5n2","kuM8f"], "kuM8f", "parcelRequire46c6")
